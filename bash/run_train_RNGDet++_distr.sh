CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --standalone --nproc_per_node=4 --max-restarts=0 main_train.py --savedir RNGDet++ \
 --dataroot ./data/ --data_dir dataset --batch_size 20 --ROI_SIZE 128 --nepochs 10 --multi_GPU --backbone resnet101 --eos_coef 0.2\
 --lr 9e-5 --lr_backbone 9e-5 --weight_decay 1e-5 --noise 8 --image_size 2048\
  ...
  --clip_max_norm 0.5 --instance_seg --multi_scale
