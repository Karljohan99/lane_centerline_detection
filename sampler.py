...
class Sampler(FrozenClass):
    def __init__(self,args,image_name,data_dir):
        # args
        self.args = args
        ...
        self.load_data_and_initialization(image_name, data_dir)
    ...
    def load_data_and_initialization(self,tile_name,data_dir):
        '''
        ...
        self.reset_env()
        # load images
        self.sat_image = np.array(Image.open(os.path.join(self.args.dataroot,f'{data_dir}/region_{tile_name}_sat.png')))
    ...
    def step_expert_BC_sampler(self):
        ...
        for segment in ahead_segments:
            for v in segment:
                if v[0]<0 or v[1]<0 or v[0]>=192 or v[1]>=192:
